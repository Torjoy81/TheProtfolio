export default function About() {
  return (
    ...
    >
      <h1
        class="text-4xl font-medium font-montserrat underline"
        style={{
      ...
      <p class={"text-justify mt-4 xs:px-8"}>
        ...
        allowing me to make a interactive component to component and creating a
        responsive web applications.In addition, I have started an exploration
        into Angular, another powerful frontend framework. Even though I am only
        getting started with Angular, I have already learned a lot Because it
        has same concept alike vue or react.I am getting with Typescript Because
        recently I worked a couple of features of frontend like
      ...
      <p class={"text-justify mt-4 xs:px-8"}>
        ...
        learner. as example This Protfolio has been made by Fresh and deno.
      </p>
    </div>
  );
}
